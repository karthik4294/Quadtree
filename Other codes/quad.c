...
//Removed windows-specific header and functio 
...

{
    ...
    quadtree_node * nodeIn = new quadtree_Node;   //Initialised node
  ...
  if(points > 100)

    {
...

        {
            ...
            n->child[k] = new quadtree_node;      //Initialised node
...
void PrintQuadTree(quadtree_node *n, int depth)
...
void DeleteQuadTree(quadtree_node *n)
...
quadtree_node *BuildNode(quadtree_node *n, quadtree_node *nParent, int index)
